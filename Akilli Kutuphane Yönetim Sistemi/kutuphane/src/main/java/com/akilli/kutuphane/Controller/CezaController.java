...
public List<Ceza> getMyFines(@PathVariable Long kullaniciId) {
    // Service katmanını çağırıyoruz
    return cezaService.findByKullaniciId(kullaniciId);  // bunu yeni ekledim kullanıcı cezalarını görebilsin diye
}
}
